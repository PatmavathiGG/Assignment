...
public class Application {
	...
	public void submitUserDetails() {
		...
		ContactDetails cd = new ContactDetails(houseNumber, cityName, stateName, localityName,countryName, pinCode, mobileNumber,
				emailId);
		Account ac = new Account(accountNumber, userName, password, balance);
		ac.setContactDetails(cd);
		ac.setKycDetails(kyc);
	...
	private void printUserKYCDocumentDetails() {
		...
		Account ac = getAllDetail(accNo);
		System.out.println("--------------------------------------------------");
		System.out.println(ac.getKycDetails());
		System.out.println("--------------------------------------------------");
